...
SWIFT_MODULE_NAMESPACE_PUSH("trace")
...
SWIFT_CLASS("_TtC5trace27ConsultOTAccountAppResponse")
...
SWIFT_CLASS("_TtC5trace13IconTextField")
...
SWIFT_CLASS("_TtC5trace20TimeToArriveResponse")
@interface TimeToArriveResponse : BaseResponse
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC5trace21TracingViewController")
@interface TracingViewController : BaseViewController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC5trace9WorkOrder")
